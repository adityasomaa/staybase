...
export const channelTone: Record<ChannelCode, string> = {
  booking_com: "bg-blue-500/10 text-blue-600 border-blue-500/20",
  airbnb: "bg-rose-500/10 text-rose-600 border-rose-500/20",
  expedia: "bg-amber-500/10 text-amber-600 border-amber-500/20",
  agoda: "bg-violet-500/10 text-violet-600 border-violet-500/20",
  traveloka: "bg-sky-500/10 text-sky-600 border-sky-500/20",
  tiket_com: "bg-indigo-500/10 text-indigo-600 border-indigo-500/20",
  direct: "bg-teal-500/10 text-teal-600 border-teal-500/20",
...
export const statusTone: Record<string, string> = {
  ...
  in_house: "bg-blue-500/10 text-blue-600 border-blue-500/20",
  ...
  dirty: "bg-amber-500/10 text-amber-600 border-amber-500/20",
  inspected: "bg-blue-500/10 text-blue-600 border-blue-500/20",
