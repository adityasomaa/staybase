 ...
 *
 * A step in an article links to `?focus=<target id>`; this finds the element
 * carrying `data-tour="<target id>"`, scrolls to it, marks it so the
 * stylesheet can ring it, and says what the reader is looking at.
 *
 * Guided setup used to ride on this too, dimming the screen around the ring.
 * It was removed: on a new workspace the controls it pointed at were empty
 * tables, so it spotlighted nothing. Setup is a checklist in the header now,
 * which can say "no room types yet" instead of drawing a ring around the fact.
 *
